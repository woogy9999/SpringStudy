				...
				<table class="table">
					...
					<tr>
						...
						<input type=text name=subject size=50 required
							class="input-sm" ref="subject" v-model="subject"></td>
					</tr>
					<tr>
						<th width=15%>내용</th>
						<td width=85%><textarea rows="5" cols="52" name=content
								required ref="content" v-model="content"></textarea></td>
					</tr>

					<tr>
						<th width=15%>첨부파일</th>
						<td width=85%>
						<input type=file class="input-sm" multiple="multiple" ref="files" v-model="files"
						accept="upload/*"></td>
					</tr>
					...
					<tr>
						...
						class="input-sm" ref="pwd" v-model="pwd"></td>
					</tr>
					<tr>
